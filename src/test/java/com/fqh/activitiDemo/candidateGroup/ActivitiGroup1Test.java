...
/**
 * @author fqh
 * @Description: 分配审批组-流程图预设分组
 * @date 2020/4/6下午11:49
 */
public class ActivitiGroup1Test {
    ...
    public void deploy(){
        Deployment deploy = processEngine.getRepositoryService().createDeployment()
                .addClasspathResource("groupUsers1.bpmn")
                .addClasspathResource("groupUsers1.png")
                .name("流程图预设分配审批人").deploy();
